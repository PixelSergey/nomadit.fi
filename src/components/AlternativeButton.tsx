...
const alternativeButtonVariants = cva(
  "relative inline-flex items-center justify-center text-sm font-medium transition-all duration-300 disabled:pointer-events-none disabled:opacity-50 overflow-hidden group transform skew-x-[-10deg] hover:skew-x-0",
  {
    variants: {
      variant: {
